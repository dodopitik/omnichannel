...
async function main() {
    ...
    const superAdminRole = await prisma.role.upsert({
        ...
        update: { displayName: 'Super Administrator', type: client_1.RoleType.SUPER_ADMIN, isSystem: true },
        create: {
            name: 'super_admin',
    ...
    const adminRole = await prisma.role.upsert({
        where: { name: 'admin' },
        update: { displayName: 'Administrator', type: client_1.RoleType.ADMIN, isSystem: true },
        create: {
            name: 'admin',
    ...
    const managerRole = await prisma.role.upsert({
        where: { name: 'manager' },
        update: { displayName: 'Manager', type: client_1.RoleType.MANAGER, isSystem: true },
        create: {
            name: 'manager',
            displayName: 'Manager',
    ...
    await prisma.role.upsert({
        where: { name: 'staff' },
        update: { displayName: 'Staff', type: client_1.RoleType.STAFF, isSystem: true },
        create: {
            name: 'staff',
            displayName: 'Staff',
